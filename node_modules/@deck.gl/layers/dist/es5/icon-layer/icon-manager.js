  ...
  (0, _createClass2.default)(IconManager, [{
    ...
    value: function packIcons(data, getIcon) {
      ...
      if (icons.length > 0) {
        ...
        if (!this._texture) {
          var _this$_textureParamet;

          this._texture = new _core.Texture2D(this.gl, {
            width: this._canvasWidth,
            height: this._canvasHeight,
            parameters: (_this$_textureParamet = this._textureParameters) !== null && _this$_textureParamet !== void 0 ? _this$_textureParamet : DEFAULT_TEXTURE_PARAMETERS
          });
        }
